...
ICTD_round1 <- function(data_bulk)
{
  ...
  R1_filter_step1_results_new <- R1_list_filtering_step1_new_BCV2(list_new_c2, data_CORS_cancer = data_ccc, max_cut = 7, cutn0 = 7, cut10 = 0.7, IM_id_list, immune_cell_uni_table = immune_cell_uni_table0_GS)
